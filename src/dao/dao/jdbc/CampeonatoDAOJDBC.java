...
// Implementação JDBC de ICampeonatoDAO
public class CampeonatoDAOJDBC implements ICampeonatoDAO {
    ...
    public void adicionarClube(Campeonato campeonato, Clube clube) {
        ...
        try (Connection conn = ConexaoDB.getConexao();
            ...
            stmt.setInt(2, new ClubeDAOJDBC().buscarId(clube.getNome()));
            stmt.executeUpdate();
        } catch (SQLException e) {
    ...
    // método auxiliar privado — monta a lista de clubes de um campeonato via JOIN
