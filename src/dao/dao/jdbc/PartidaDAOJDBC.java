...
// Implementação JDBC de IPartidaDAO
public class PartidaDAOJDBC implements IPartidaDAO {
    ...
    public void salvar(Partida partida, Campeonato campeonato) {
        ...
        dao.jdbc.ClubeDAOJDBC clubeDAO = new ClubeDAOJDBC();
        try (Connection conn = ConexaoDB.getConexao();
            ...
            stmt.setInt(3, new CampeonatoDAOJDBC().buscarId(campeonato.getNome()));
