...
public class Administrador extends Pessoa {
    ...
    @Override
    public String getTipo() {   // no pessoa é abstrato os filhos que se virem - definiu string
        return "Administrador"; // definiu que é um adm
    }

    @Override
    public String exibirInfo()m {  // sobrescreve falando "adm carlos na hora de exibir
